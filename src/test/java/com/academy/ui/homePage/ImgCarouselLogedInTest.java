...
public class ImgCarouselLogedInTest extends LoginWithUserTestRunner {
    ...
    public void verifyImgCarouselCard3(){
        ...
        System.out.println(driver.getCurrentUrl().contains("about"));
        softAssert.assertTrue(challengeImageText.getText().contains("Навчай українською"));
        System.out.println(challengeImageText.getText().contains("Навчай українською"));
    ...
    private void performActionsToCheckElementsOnTheImgCard(int imgCardToCheckIndex, int imgCardAdditionalForSwitchingDuringCheckIndex){
        ...
        softAssert.assertTrue(
                homePage.carouselImgComponent
                        .getSlickDotByIndex(imgCardToCheckIndex)
                        .getCssValue("background")
                        .contains("rgb(250, 140, 22)") ||
                        homePage.carouselImgComponent
                                .getSlickDotByIndex(imgCardToCheckIndex)
                                .getCssValue("background")
                                .contains("rgb(248, 142, 27)")
        );
       System.out.println(homePage.carouselImgComponent.getSlickDotByIndex(imgCardToCheckIndex).getCssValue("background").contains("rgb(250, 140, 22)"));
        ...
        System.out.println(homePage.carouselImgComponent.getSlickDotByIndex(imgCardToCheckIndex).getCssValue("background").contains("rgb(196, 196, 196)"));

        softAssert.assertTrue(homePage.carouselImgComponent.getSlickDotsContainer().getCssValue("justify-content").contains("center"));
        System.out.println(homePage.carouselImgComponent.getSlickDotsContainer().getCssValue("justify-content").contains("center"));
        ...
        System.out.println(homePage.carouselImgComponent.getWebElement().getCssValue("align-items").contains("center"));
        homePage.carouselImgComponent.clickSlickDotByIndex(imgCardToCheckIndex);
        ...
        System.out.println(homePage.carouselImgComponent.getActiveCarouselImgCard().getCardButton().getCssValue("background").contains("rgb(250, 140, 22)"));
        homePage.carouselImgComponent.clickSlickDotByIndex(imgCardToCheckIndex);
        if(! homePage.carouselImgComponent.getCarouselImgCardByDataIndex(imgCardToCheckIndex).getCardButton().isDisplayed()){
            wait.until(ExpectedConditions.visibilityOf(homePage.carouselImgComponent.getCarouselImgCardByDataIndex(imgCardToCheckIndex).getCardButton()));
        }

        System.out.println(homePage.carouselImgComponent.getCarouselImgCardByDataIndex(imgCardToCheckIndex).getCardButtonText().getCssValue("color").contains("rgba(255, 255, 255, 1)"));
        softAssert.assertTrue(homePage.carouselImgComponent.getCarouselImgCardByDataIndex(imgCardToCheckIndex).getCardButtonText().getCssValue("color").contains("rgba(255, 255, 255, 1)"));
        ...
        System.out.println(homePage.carouselImgComponent.getActiveCarouselImgCard().getCardButtonText().getCssValue("color").contains("rgba(255, 255, 255, 1)"));
        if(!homePage.carouselImgComponent.getCarouselImgCardByDataIndex(imgCardToCheckIndex).getCardButton().isDisplayed()){
            wait.until(ExpectedConditions.visibilityOf(homePage.carouselImgComponent.getCarouselImgCardByDataIndex(imgCardToCheckIndex).getCardButton()));
        }
