...
public class AddClubPopUpComponent extends BasePopUp {
    ...
    @Step("Get first step 'Основна інформація' on the Add club pop-up")
    ...
    @Step("Get second step 'Контакти' on the Add club pop-up")
    ...
    @Step("Get third step 'Опис' on the Add club pop-up")
